...
import 'package:dashkai/screens/payments_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  AuthenticationService signout = AuthenticationService();
                                                ...
                                                children: [
                                                  FutureBuilder<Widget>(
                                                    ...
                                                    builder:
                                                      ...
                                                      if (snapshot.hasData) {
                                                        return snapshot
                                                            .data!; // Display the Text widget returned by switchToHostAccount
                                                      } else if (snapshot
                                                          .hasError) {
                                                        return Text(
